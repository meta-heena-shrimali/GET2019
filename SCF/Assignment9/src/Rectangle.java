/**
 * Implements class that extends Shape class,represents rectangle shape and implements functions such as getArea(), getPerimeter(),
...
public class Rectangle implements Shape {
    ...
    */
	...
	public boolean isPointEnclosed(Point point) {
		if (point.getxCoordinate() >= origin.getxCoordinate() && point.getyCoordinate() >= origin.getyCoordinate()
				&& point.getxCoordinate() < origin.getxCoordinate() + length
				&& point.getyCoordinate() < origin.getyCoordinate() + width) {
			return true;
		}
		return false;
	}
