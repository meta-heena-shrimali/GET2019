...
public class AdvertisementResource {
    ...
    String key = "get2019";
    AdvertisementFacade advertisementFacade = BaseFactory
            .createAdvertisementFacade();

    @POST
    @Path("/InsertAdvertisement/{id}/{title}/{desc}/{categoryID}")
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Status insertAdvertisement(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Status updateAdvertisement(
            @HeaderParam("Authorization") String authorization,
            @PathParam("id") int id, @PathParam("title") String title,
            @PathParam("desc") String desc,
            @PathParam("categoryID") int categoryID) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Status deleteAdvertisement(
            @HeaderParam("Authorization") String authorization,
            @PathParam("id") int id) {
