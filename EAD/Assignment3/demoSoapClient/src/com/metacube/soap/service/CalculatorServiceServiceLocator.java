...
public class CalculatorServiceServiceLocator extends org.apache.axis.client.Service implements com.metacube.soap.service.CalculatorServiceService {
    ...
    private java.lang.String CalculatorService_address = "http://localhost:8080/demoSoap/services/CalculatorService";
    ...
    public com.metacube.soap.service.CalculatorService getCalculatorService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.soap.service.CalculatorServiceSoapBindingStub _stub = new com.metacube.soap.service.CalculatorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.soap.service.CalculatorService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.soap.service.CalculatorServiceSoapBindingStub _stub = new com.metacube.soap.service.CalculatorServiceSoapBindingStub(new java.net.URL(CalculatorService_address), this);
                _stub.setPortName(getCalculatorServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.soap.metacube.com", "CalculatorServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.soap.metacube.com", "CalculatorService"));
        }
